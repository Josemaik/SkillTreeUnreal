...
#include "SkillTreeUnrealCharacter.generated.h"
...
DECLARE_DELEGATE(FOnSkillPointsUpdated);

UCLASS(config=Game)
class ASkillTreeUnrealCharacter : public ACharacter
{
	GENERATED_BODY()
...
public:
	FOnSkillPointsUpdated OnSkillUnlocked;
	
	ASkillTreeUnrealCharacter();

	void RemoveSkillsPoints(int32 Cost);
